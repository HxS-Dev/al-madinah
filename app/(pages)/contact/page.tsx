      ...
      <section className='w-full py-16 md:py-32'>
        <div className="w-full max-w-[1440px] mx-auto px-3 md:px-5">
          <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-5">
            ...
            <ul className='flex flex-wrap items-center gap-3 md:gap-4 pt-8 md:pt-10'>
              <li>
                <a className='w-[40px] md:w-[45px] h-[40px] md:h-[45px] rounded-full text-gray-300 transition-all duration-300 hover:scale-105 hover:bg-green-100 hover:text-green-400 p-1 bg-gray-100 flex items-center justify-center' href="#">
                <svg
                  fill="currentColor"
                  width="26px"
                  height="26px"
              ...
              <li>
                <a className='w-[45px] h-[45px] text-gray-300 rounded-full transition-all duration-300 hover:scale-105 hover:bg-green-100 hover:text-green-400  p-1 bg-gray-100 flex items-center justify-center' href="#">
              ...
              <li>
                <a className='w-[45px] h-[45px] text-gray-300 rounded-full transition-all duration-300 hover:scale-105 hover:bg-green-100 hover:text-green-400 p-1 bg-gray-100 flex items-center justify-center' href="#">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M7.8,17.9c-3.2,0-5.9-2.6-5.9-5.9s2.6-5.9,5.9-5.9c1.5,0,2.9,0.6,4,1.5l-1.7,1.7C9.4,8.8,8.6,8.5,7.8,8.5
